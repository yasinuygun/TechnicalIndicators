    ...
    public partial class View : Form
    {
        ...
        private void mavParameterNext_Click(object sender, EventArgs e)
        {
            ...
            if (MapReduceAllowed)
            {
                ...
                emaData = MovingAverage.ExponentialMR(Code, TargetDate, MAVPeriod);
            }
            else
            {
                ...
                emaData = MovingAverage.Exponential(Code, TargetDate, MAVPeriod);
            }
        ...
        private void macdParameterNext_Click(object sender, EventArgs e)
        {
            ...
            var closeData = IndicatorService.GetData(Code, TargetDate, new string[] { "Tarih", "Kapanis" }, FirstPeriod);

            MovingAverageConvergenceDivergence macd = new MovingAverageConvergenceDivergence(Code, TargetDate, FirstPeriod, SecondPeriod, TriggerPeriod, MapReduceAllowed);
